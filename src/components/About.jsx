...
//             <p className='text-gray-400 text-center mx-auto mb-16 max-w-2xl'>Get to know more about my background and passion</p>
//             {/* img and my journy*/}
...
//                  src="/src/assets/WhatsApp Image 2026-03-27 at 7.53.57 AM.jpeg" alt="" />
//                  </div>
//                     {/* text contant*/}
//                  <motion.div
//                   initial = {{opacity:0, y:50}}
...
//                         <p className='text-gray-300 mb-6'>I'm passionate Frontened developer with over 1 year of experience
//                         creating digital solutions for bussinesses around the world.
//                          My journey started with basic HTML/CSS and has evolved into
//                          building complex web application with modern frameworks</p>
//                         <p className='text-gray-300 mb-6'>When I'm not coding , you can find me exploring new tecnologies,
//                              contributing to open source projects, or sharing my knowledge
//                               through tech blogs and tutorials. I believe in continuous
//                                learning and pushing the boundries of what's possible on the web</p>
//                                {/*cards */}
//                                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
//                                 {
//                                     aboutInfo.map((data, index)=>{
//                                         return(
//                                     <div key={index} className='bg-dark-300 rounded-2xl p-4
