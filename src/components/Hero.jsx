...
//         <h1 className='text-4xl md:text-6xl font-bold mb-4'>Hi I'm <span className='text-purple'>Ali Hamza</span></h1>
//         <h2 className='text-2xl font-semibold md:text-4xl mb-6 typewriter'>Frontened Developer</h2>
//         <p className='text-lg text-gray-300 mb-8'>I create stunning web experiences with modren tecnologies and innovative design.</p>
//         <div className='flex space-x-4 '>
//           <a href="#projects" className='px-6 bg-purple rounded-lg py-3 font-medium hover:bg-purple-700 transition duration-300'>View Work</a>
//           <a href="#contact" className='px-6 border border-purple rounded-lg py-3 font-medium hover:bg-purple/20 transition duration-300'>Contact Me</a>
//         </div>
//         </div>
//         {/*right side img*/}
...
//               ease:easeInOut,
//             }}
//             className='relative rounded-full w-64 h-64 md:w-80 md:h-80 object-cover z-10 animate-flow' src="/src/assets/WhatsApp Image 2026-03-27 at 7.53.57 AM.jpeg" alt="" />
